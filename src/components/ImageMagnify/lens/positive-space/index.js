...
import LensPropTypes from '@skp/components/ImageMagnify/prop-types/Lens';
...
export default class PositiveSpaceLens extends Component {
    ...
    get isVisible() {
        const { isActive, isPositionOutside } = this.props;
    ...
    get priorityStyle() {
        ...
        const { top, left } = this.positionOffset;
    ...
    render() {
        return <div style={this.compositStyle} />;
    }
}
