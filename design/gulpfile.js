...
// ======================================================
// TASK for dev only, no remove folder dest when build
// ======================================================
gulp.task('build-without-clean', function(cb) {
  gulp.series(
    'copy:favicon',
    'copy:fonts',
    'copy:images',
...
// ======================================================
// TASK for CI only, don't need to build markup
// ======================================================
gulp.task('build-without-markup', function(cb) {
  gulp.series(
    'cleanup',
    'copy:favicon',
    'copy:fonts',
