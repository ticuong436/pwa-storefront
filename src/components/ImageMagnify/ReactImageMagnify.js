...
class ReactImageMagnify extends React.Component {
    constructor(props) {
        ...
        this.setSmallImageDimensionState = this.setSmallImageDimensionState.bind(
            this
        );
        this.onDetectedInputTypeChanged = this.onDetectedInputTypeChanged.bind(
            this
        );
    }
    ...
    get enlargedImagePlacement() {
        ...
        return (
            userDefinedEnlargedImagePosition || computedEnlargedImagePosition
        );
    }
    ...
    get lensComponent() {
        const { shouldUsePositiveSpaceLens, lensComponent } = this.props;
